...
class ExplorationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exploration" do
    assert_difference('Exploration.count') do
      post explorations_url, params: { exploration: { latitude: @exploration.latitude, location: @exploration.location, longitude: @exploration.longitude } }
    end
  ...
  test "should update exploration" do
    patch exploration_url(@exploration), params: { exploration: { latitude: @exploration.latitude, location: @exploration.location, longitude: @exploration.longitude } }
